            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}", 
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        # overfit_batch = dataset[0]
                        # overfit_batch = dict_apply(overfit_batch, lambda x: x.unsqueeze(0).repeat((cfg.dataloader.batch_size, *([1]*x.dim()))))
                        # overfit_batch = dict_apply(overfit_batch, lambda x: x.to(device, non_blocking=True))
                        # compute loss
