...
class DiffuserActorEncoder(ModuleAttrMixin):
    ...
    def __init__(self,
        ...
        self.self_attn = InvariantPointTransformer(
            embedding_dim, 3, num_attn_heads, head_dim, kv_dim=None,
    ...
    def _encode_gripper(self, gripper, gripper_embed, context_feats, context):
        ...
        poses = {}
        poses['rotations'] = gripper[..., :3, :3]
        poses['translations'] = gripper[..., :3, 3]
        gripper_feats = self.self_attn(gripper_feats, poses)
