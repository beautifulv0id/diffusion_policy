...
from diffusion_policy.model.obs_encoders.diffuser_actor_pose_invariant_lowdim_PIA_encoder import DiffuserActorEncoder
...
class DiffusionHead(nn.Module):
    ...
    def prediction_head(self,
        ...
        # Self attention among trajectory + curr_gripper
