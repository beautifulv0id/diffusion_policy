...
from diffusion_policy.model.obs_encoders.se3_grasp_pcd_encoder import SE3GraspFPSEncoder
from diffusion_policy.model.obs_encoders.feature_pcd_encoder import FeaturePCDEncoder
from diffusion_policy.model.flow_matching.se3_grasp_vector_field_self_attn import SE3GraspVectorFieldSelfAttn
from diffusion_policy.model.common.workspace_cropping import crop_to_workspace
from diffusion_policy.model.decoder.se3_pcd_self_attn_decoder import SE3PCDSelfAttnDecoder
...
class SE3FlowMatchingSelfAttn(BaseImagePolicy):
