...
#SBATCH --array=0-3%1
#SBATCH --output=/home/stud_herrmann/diffusion_policy_felix/slurm_scripts/logs/%A_turn_tap_lowdim/train_%a.out
#SBATCH -J turn_tap_lowdim

training_script=train_diffuser_actor_pose_invariant_lowdim.py
task_name=turn_tap
task_config=turn_tap_lowdim
