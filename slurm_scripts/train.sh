...
#SBATCH --gres=gpu:1
#SBATCH --array=0-8%1
#SBATCH --output=../data/logs/%A_train/train_%a.out
#SBATCH -J train

config_name=train_se3_flow_matching
...
HYDRA_FULL_ERROR=1
HYDRA_RUN_DIR_FILE=${DIFFUSION_POLICY_ROOT}/data/logs/${SLURM_ARRAY_JOB_ID}_${config_name}/hydra_run_dir.txt
