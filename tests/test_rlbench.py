...
demo = get_stored_demos(amount=1, dataset_root=data_path, task_name=task_str, variation_number=0, from_episode_number=0, image_paths=False, random_selection=False, obs_config=obs_config)[0]
